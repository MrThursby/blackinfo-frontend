          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="form-row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input v-model="form.middle_name" type="text" class="form-control" id="middle_name">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="passport">Серия и номер пасспорта</label>
                    <input v-model="form.passport" type="text" class="form-control" id="passport">
                  </div>
                  <div class="form-group">
                    <label for="passport_issued_by">Кем выдан</label>
                    <input v-model="form.passport_issued_by" type="text" class="form-control" id="passport_issued_by">
                  </div>
                  <div class="form-group">
                    <label for="passport_issued_date">Когда выдан</label>
                    <input v-model="form.passport_issued_date" type="text" class="form-control"
              ...
              <div class="form-group">
                ...
                <input v-model="form.violation" type="text" class="form-control" id="violation">
              </div>
              <div class="form-group">
                <label for="violation_status">Ущерб</label>
                <div class="custom-control custom-switch">
                  <input v-model="form.violation_status" type="checkbox" class="custom-control-input" id="violation_status">
                  <label class="custom-control-label" v-if="form.violation_status === false" for="violation_status">Не возмещён</label>
